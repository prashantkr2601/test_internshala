...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2020 at 08:21 AM
...
('Restaurant', 24, 'Ka Eclairs & Kafe', 'KaEclairs&Kafe@gmail.com', '$2y$10$4XP50DxUYxxQf1J/HHUogObaUZS75k3jh.7S5UXc9EmQqBYLjSiyW', 'Delhi', 'Ka Eclairs & Kafe has managed to seamlessly integrate the technology with the physical process of bringing the food to a consumer doorstep. Eat Good Eat Safe.', 250, 50, 4.2, 'Cash and Online', 'Veg and Nonveg', '2020-08-04 10:10:04'),
...
--
ALTER TABLE `items`
  MODIFY `item_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `order_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;

--
-- AUTO_INCREMENT for table `restaurants`
--
ALTER TABLE `restaurants`
  MODIFY `res_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
